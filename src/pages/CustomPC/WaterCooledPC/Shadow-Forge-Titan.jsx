...
const ShadowForgeTITAN = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      >
        <div>
          <h1 className="text-5xl font-serif mb-6">SHADOW-FORGE TITAN</h1>
          <p className="text-4xl mb-4">₹ 3,82,500</p>
          <p className="text-gray-300 mb-8">
          Introducing the ShadowForge: Where obsidian aesthetics meld with searing performance. This all-AMD powerhouse wields liquid cooling to defy thermal boundaries, ensuring your gaming experience remains as dark and flawless as forged shadows. 🌑🔥
          </p>
        ...
        >
          <img 
            src="/public/SFTITAN.png" 
            alt="Shadow Forage Titan" 
...
export default ShadowForgeTITAN;
