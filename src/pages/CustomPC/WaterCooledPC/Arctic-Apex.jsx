        ...
        >
          ...
          <div>
            ...
            <button className="mt-6 bg-orange-500 text-white px-8 py-3 rounded hover:bg-orange-600 transition-colors uppercase"
             onClick={() => window.location.href = 'https://www.intel.com/content/www/us/en/products/sku/230496/intel-core-i913900k-processor-36m-cache-up-to-5-80-ghz/specifications.html'}
        ...
        >
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              ...
              onClick={
                () => window.open('https://www.nvidia.com/en-us/geforce/graphics-cards/40-series/rtx-4090/#specs', '_blank')
              }
              >
                View Full Specs
              </button>
