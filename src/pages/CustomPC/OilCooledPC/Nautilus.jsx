...
const Nautilus = () => {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      >
        <div>
          <h1 className="text-5xl font-serif mb-6">NAUTILUS</h1>
          <p className="text-4xl mb-4">₹ 5,00,000</p>
          <p className="text-gray-300 mb-8">
          Introducing the Nautilus: Where frost meets fire, and power takes  flight. With the icy breath of the Arctic, this PC  defies thermal limits. Unleash unparalleled performance, soar through gaming  heights, and let the legend lead the way.
          </p>
      ...
      <section className="px-8 py-16 max-w-7xl mx-auto space-y-24">
        ...
        >
          ...
          <div>
            ...
            Nautilus has cutting-edge performance for both recreational and  professional gamers thanks to the latest 13th Gen Intel® Core™ desktop  CPUs. 13th Generation Intel® Core™ desktop CPUs are built for both  gaming and work, with up to 24 cores and 32 threads, 5.8 GHz clock  rates, and 36 MB cache.
            </p>
            <button className="mt-6 bg-orange-500 text-white px-8 py-3 rounded hover:bg-orange-600 transition-colors uppercase"
            onClick={() => {
              window.location.href = "https://www.intel.com/content/www/us/en/products/sku/230496/intel-core-i913900k-processor-36m-cache-up-to-5-80-ghz/specifications.html";
            }}
            >
              View Full Specs
            </button>
        ...
        >
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-6xl font-serif mb-8 text-white">GEFORCE RTX 4090</h2>
              ...
              onClick={() => {
                window.location.href = "https://www.nvidia.com/en-us/geforce/graphics-cards/40-series/rtx-4090/#specs";
              }}
              >
                View Full Specs
              </button>
